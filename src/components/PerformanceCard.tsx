...
const borderColor: Record<string, string> = {
  tezuka: "border-rose-400",
  dracom: "border-sky-400",
  sakata: "border-amber-400",
  slopes: "border-emerald-400",
  tsubure: "border-purple-400",
  sakai: "border-pink-400",
  hosoma: "border-indigo-400",
};
...
export function PerformanceCard({ performance, index = 0 }: Props) {
  ...
  return (
    <Link
      ...
      className={`group block bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border-2 border-yellow ${tilt} hover:rotate-0`}
    >
